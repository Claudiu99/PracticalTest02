...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class ConnectButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (serverThread.getServerSocket() == null) {
                Log.e(SyncStateContract.Constants.TAG, "[MAIN ACTIVITY] Could not create server thread!");
                return;
            }
            serverThread.start();
        }
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            weatherForecastTextView.setText(SyncStateContract.Constants.EMPTY_STRING);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(SyncStateContract.Constants.TAG, "[MAIN ACTIVITY] onCreate() callback method has been invoked");
